...
public class CustomerService {
	...
	static {
		customers.add(new Customer(1, "Santi Abascal", "00000001Ñ", "santi@voxespana.es"));
		customers.add(new Customer(2, "Jose Antonio Ortega Lara", "00000002Ñ", "pepetoni@voxespana.es"));
		customers.add(new Customer(3, "Rocio Monasterio", "00000003Ñ", "rocimona@voxespana.es"));
		customers.add(new Customer(4, "Jorge Arturo Cutillas", "00000004Ñ", "cuti@voxespana.es"));
		customers.add(new Customer(5, "Javier Pérez", "00000005Ñ", "javipe@voxespana.es"));
	}
